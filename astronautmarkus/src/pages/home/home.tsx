...
import { Github, Linkedin, Mail, Rocket, Twitter, Instagram, ChevronRight, Clock, Code, Coffee } from "lucide-react";
        ...
        <>
            ...
            <section className="py-16">
                <div className="container mx-auto px-4 sm:px-6">
                    ...
                    >
                        <motion.div
                            className="bg-white rounded-lg w-40 h-28 sm:w-48 sm:h-32 flex flex-col items-center justify-center shadow-lg border border-gray-200 mx-auto"
